...
#include "Vehicles/PlaneBase.h"

// Camera & SpringArm
#include "Camera/CameraComponent.h"
#include "GameFramework/SpringArmComponent.h"

FName APlaneBase::SpringArmComponentName(TEXT("SpringArm"));
FName APlaneBase::CameraComponentName(TEXT("Camera"));
FName APlaneBase::VehicleMeshComponentName(TEXT("VehicleMesh"));

APlaneBase::APlaneBase(const FObjectInitializer& ObjectInitializer)
